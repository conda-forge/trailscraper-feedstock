...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/trailscraper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12765&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/trailscraper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `trailscraper` can be installed with:

```
conda install trailscraper
```

It is possible to list all of the versions of `trailscraper` available on your platform with:
